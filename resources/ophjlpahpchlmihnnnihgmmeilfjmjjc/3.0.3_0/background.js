...
//   if ( e ) {if ( await new Promise( ( o => {chrome.windows.update( e, { focused : !0 }, ( e => {e ? o( !0 ) : ( mainWindowId.remove(), o( !1 ) );} ) );} ) ) ) return;}
//   await checkAndDeleteLegacyData().catch( ( e => {console.warn( 'Failed to delete legacy data', e );} ) );
//   const o = await chrome.system.display.getInfo(), { bounds : a } = o[ 0 ],
//         n = { left : a.left + a.width / 2 - 400, top : a.top + a.height / 2 - 290 }, t = await chrome.windows.create( {
...
//           type : 'panel'
//         } );
//   mainWindowId.set( t.id ), chrome.action.setIcon( {
//     path : {
...
//     }
//   } ), chrome.action.setBadgeText( { text : '' } ), mainWindowId.remove() );
// } ) );
